...
import com.ai.reviewer.backend.config.HealthControllerTestConfig;
import com.ai.reviewer.backend.domain.orchestrator.ReviewOrchestrator;
import com.ai.reviewer.backend.infra.adapter.github.GithubConfig;
import com.ai.reviewer.backend.infra.adapter.github.GithubApiClient;
...
@ContextConfiguration(classes = HealthControllerTestConfig.class)
@ActiveProfiles("test")
@WithMockUser
